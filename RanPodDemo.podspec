...
Pod::Spec.new do |s|
  s.name             = 'RanPodDemo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RanPodDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ran/RanPodDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ran' => 'ran@ran.com' }
  s.source           = { :git => 'https://github.com/ran/RanPodDemo.git', :tag => s.version.to_s }
